...
import com.TestiniumTask.Utilities.ConfigurationReader;
...
public class BaseTest {
    ...
    public final static Logger log4j = Logger.getLogger(TestiniumTest.class);
    ...
    public void before() {
        ...
        report.setSystemInfo("User Name", "Erva Ulker");
